...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order order1 = new Order(null, Instant.parse("2021-02-20T19:52:37Z"), user1);
		Order order2 = new Order(null, Instant.parse("2021-03-20T21:33:42Z"), user2);
		Order order3 = new Order(null, Instant.parse("2021-04-20T15:07:02Z"), user1);
